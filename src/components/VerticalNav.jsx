  ...
  return (
    <nav className={`horizontal-nav ${isVisible ? 'nav-visible' : 'nav-hidden'}`}>
      ...
      <div className={`nav-links ${isMenuOpen ? 'nav-links-open' : ''}`}>
        ...
        <a href="https://drive.google.com/file/d/13gaNyLV2URsI6XD5APgCqVhZ95dUwDlz/view?usp=sharing" target="_blank" className="nav-link" onClick={() => setIsMenuOpen(false)}>Resume</a>
